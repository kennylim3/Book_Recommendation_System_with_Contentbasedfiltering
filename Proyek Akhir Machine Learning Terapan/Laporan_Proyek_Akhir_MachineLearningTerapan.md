...
### Problem Statements
- Bagaimana membantu pengguna menemukan buku yang sesuai dengan minat dan preferensi mereka di tengah banyaknya pilihan bacaan yang tersedia?
- Bagaimana membuat eksplorasi bacaan pengguna lebih efisien?

### Goals
- Mengembangkan sistem rekomendasi buku yang efektif untuk membantu pengguna menemukan bahan bacaan yang sesuai dengan minat dan preferensi mereka dengan lebih mudah.
- Meningkatkan pengalaman membaca pengguna dengan memberikan rekomendasi yang personal dan relevan.
...
Pendekatan ini akan memanfaatkan pola perilaku pengguna dan informasi dari pengguna lain untuk membuat rekomendasi. Sistem akan menganalisis data riwayat pembelian atau penilaian pengguna dan mencari pola kesamaan antara pengguna yang memiliki preferensi yang serupa. Kemudian, sistem akan merekomendasikan buku yang disukai oleh pengguna dengan profil serupa kepada pengguna yang sedang mencari rekomendasi.

## Data Understanding
Data yang akan digunakan pada proyek ini adalah dataset Books dataset yang diambil dari Kaggle. Dataset tersebut berisi 1000 records data buku.
